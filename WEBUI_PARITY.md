...
- 对比版本：`7f4408325ff7dece0b98a13185dd3576d0605f60`（`dsh-v0.1.1-rc.2`，基于官方 `dsh-v0.1.1-rc.2` 并保留 Deeptop 的 preset fork 迁移、pi-ai 思考 tokens 与 PowerShell Store 重探测补丁）。
